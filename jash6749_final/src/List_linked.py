...
class List:
    ...
    def rotate_rear(self):
        ...
        """
        # Your code here
        if self._rear is not None and self._rear is not self._front:
            curr = self._front
            prev = curr
            while curr is not None:
                prev = curr
    ...
    def has_loop(self):
        ...
        if self._front is not None:
            curr = self._front
            nxt = self._front._next

            while nxt is not None and nxt._next is not None and loop == False:
                if curr == nxt or curr == nxt._next:
                    loop = True
