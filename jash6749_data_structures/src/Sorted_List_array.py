...
class Sorted_List:
    ...
    def __contains__(self, key):
        ...
        ret = False
        ind = 0
        while ind < len(self._values) and not ret:
    ...
    def insert(self, value):
        ...
        ind = 0
        length = len(self._values)
        while ind < length and value >= self._values[ind]:
            ind += 1
    ...
    def remove(self, key):
        ...
        for value in self._values:
            if value == key:
                val = self._values.pop(self._values.index(value))
    ...
    def split(self):
        ...
        if length % 2 == 0:
            target1._values[:] = self._values[:length//2]
            target2._values[:] = self._values[length//2:]
        else:
            target1._values[:] = self._values[:length//2+1]
            target2._values[:] = self._values[length//2+1:]
